...
public class DialerUtils {
	...
	public static final int TAG_RELOGIN = 16;
	...
	public static void setDialerImageButtona(Activity parent, int viewId, int imageId, int tag, View.OnClickListener listener){
		View view = parent.findViewById(viewId);
		view.setTag(tag);
		view.setOnClickListener(listener);
		((ImageView)view.findViewById(R.id.view_dialer_button_image_imageViewa)).setImageResource(imageId);
	}
}