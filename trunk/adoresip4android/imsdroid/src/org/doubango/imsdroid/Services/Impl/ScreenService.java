...
public class ScreenService extends NgnBaseService implements IScreenService {
	...
	public IBaseScreen getCurrentScreen() {
		...
		if(activeSessionsCount == 0){
			//System.println((IBaseScreen)((Main)Engine.getInstance().getMainActivity()).getLocalActivityManager().getCurrentActivity());
			return (IBaseScreen)((Main)Engine.getInstance().getMainActivity()).getLocalActivityManager().getCurrentActivity();
		}
		else return (IBaseScreen)((Main)Engine.getInstance().getMainActivity()).getLocalActivityManager().getCurrentActivity();
		}
